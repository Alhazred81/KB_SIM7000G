...
void handleHiveView() {
  ...
  // Teszteléshez állítsd be "hans"-ra, ha látni akrod a flammenwerfert!
  String interventionStatus = "hans"; 
  ...
  // Ha Hans van, berajzoljuk a mémet kis méretben, hogy mobilon is tökéletes legyen
  if (isHans) {
    html += "<div style='text-align:center;'>";
    // Itt a Base64 tömörített kép mutatja meg a lényeget
    html += "<img src='data:image/jpeg;base64,/9j/4AAQSkZJRgABAQEASABIAAD/2wBDAP//////////////////////////////////////////////////////////////////////////////////////wgALCAABAAEBAREA/8QAFBABAAAAAAAAAAAAAAAAAAAAAP/aAAgBAQABPxA=' class='hans-meme' alt='Hans, get ze flammenwerfer'>";
    html += "</div>";
  }
